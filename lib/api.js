...
const activeVariant = `*[_type == "productVariant" && productID == ^.productID && wasDeleted != true && inStock == true] | order(options[0].value asc) [0].variantID`
    ...
    "header": *[_type == "headerSettings"][0]{
      ...
      menuDesktopLeft->{
        items[]{
          ...
          featured[]->[wasDeleted != true && isDraft != true]${product}
        }
      },
      menuDesktopRight->{
        items[]{
